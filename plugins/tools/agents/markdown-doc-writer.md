...
For purely functional documentation, code details may be entirely absent.
For technical specs, the structure might focus on algorithm steps, data flows, or implementation rationale.
