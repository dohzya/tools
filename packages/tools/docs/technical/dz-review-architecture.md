...
- `dz-review session start`, `dz-review session status`, `dz-review session add-file`, `dz-review session done`, and `dz-review session rollback`, including `--json`
