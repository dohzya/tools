class Wl < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dohzya/tools/releases/download/wl-v0.7.0/wl-darwin-arm64"
      sha256 "b7c7e3ec5a0fe3b630d87b2a1cad4fdcadf0ef90708206e72b8e239a89a1018a"
    elsif Hardware::CPU.intel?
      url "https://github.com/dohzya/tools/releases/download/wl-v0.7.0/wl-darwin-x86_64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/dohzya/tools/releases/download/wl-v0.7.0/wl-linux-arm64"
      sha256 "ea6c71c4361e465721244c1d13d1c14b3afc2afbcd02fb70a7b1e4d7983786c9"
    elsif Hardware::CPU.intel?
      url "https://github.com/dohzya/tools/releases/download/wl-v0.7.0/wl-linux-x86_64"
